...
const Register: React.FC<RegisterProps> = ({ onRegister }) => {
  ...
  return (
    <div className="login__container">
      <div className="login__card" role="region" aria-labelledby="signupTitle">
        <header className="login__header">
          <h1 id="signupTitle" className="login__title">CollabSpace</h1>
        ...
        <footer className="login__footer">
          ...
          <a className="login__link" href="/login">Sign in</a>
        </footer>
      </div>
    </div>
  );
